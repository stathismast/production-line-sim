...
Εκτέλεση
    ...
    > Αντί για 1000 μπορεί να εισαχθεί οποισδήποτε ακέραιος. Ο αριθμός αυτός
      θα είναι το πλήθος των εξαρτημάτων κάθε είδους που θα δημιουργηθούν.

Μετρήσεις
        Μέσος χρόνος για    Μέσος χρόνος από τη δημιουργία
  Υ     κατάληψη βαφείου    μέχρι τη συναρμολόγηση
 100          2037                  6540
 500          2064                  6594
1000          2071                  6612
2000          2091                  6645
...
Τυχαίοι χρόνοι κατασκευής
    > Κάθε εξάρτημα δημιουργείται σε τυχαίο χρόνο. Το εύρος των τυχαίων αυτών
      χρόνων μπορεί να οριστεί ξεχωριστά για κάθε εξάρτημα στη main (σειρά 27
      στο main.c). Η χρονική καθυστέρηση θα είναι μία τιμή από το κατώτατο
      μέχρι το ανώτερο όριο που ορίζεται σε αυτό το σημείο του προγράμματος.
      Εκεί μπορεί να οριστούν και οι χρόνοι βαφής, ελέγχου και συναρμολόγησης.
